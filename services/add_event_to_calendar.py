...
class CalendarService:
    ...
    def create_calendar_event(self, title: str, description: str, start_time: datetime, end_time: datetime) -> bytes:
        """
    ...
    def send_calendar_event(self, user_email: str, title: str, description: str, start_time: datetime, end_time: datetime):
        """
        Cria um evento de calendário e envia por email para o usuário.
        """
        calendar_bytes = self.create_calendar_event(title, description, start_time, end_time)
